...
The overall approximate API coverage (with the caveats above) is 25.7%. We prioritize implementing commonly used functions, as pyspark has many esoteric APIs.
